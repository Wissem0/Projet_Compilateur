...
HD_PWD='/home/sedira/Insa-prog/projet_sys/Projet_Compilateur/MicroProcesseur/MicroProcesseur.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroProcesseur.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroProcesseur.tcl
